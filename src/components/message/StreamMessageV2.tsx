...
export const StreamMessageV2 = React.memo(
  ...
  (prevProps, nextProps) => {
    ...
    const prevMessageStr = JSON.stringify({
      ...
      pendingQuestion: prevProps.message.pendingQuestion  // ⭐ Include pendingQuestion for AskUserQuestion support
    });
    const nextMessageStr = JSON.stringify({
      ...
      pendingQuestion: nextProps.message.pendingQuestion  // ⭐ Include pendingQuestion for AskUserQuestion support
    });
